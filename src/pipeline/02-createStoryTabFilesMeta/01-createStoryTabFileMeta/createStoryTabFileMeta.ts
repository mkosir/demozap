import { extractStoryTabFilePathInfo } from '../02-extractStoryTabFilePathInfo/extractStoryTabFilePathInfo';
import { findAssociateStoryTabFilesByName } from '../03-findAssociateStoryTabFilesByName/findAssociateStoryTabFilesByName';

import { StoryTabFileMeta } from '../../../types';

export const createStoryTabFileMeta = (
